function Get-KrakenProfitTable {
    <#
.SYNOPSIS
...
#>
    ...
    for ($p = -1; $p -le 1; $p += 0.1) {
        ...
        $profit = Find-ProfitKraken -crypto $Crypto -amount $Amount -buyfee $BuyFee -sellfee $SellFee -SellPrice $new_crypto_price -BuyPrice $current_crypto_price
