function Find-ZeroProfitPriceKraken {
<#
.SYNOPSIS
...
#>
    ...
    while ($true) {
        ...
        $profit = Find-ProfitKraken -Crypto $Crypto -Amount $Amount -BuyFee $BuyFee -SellFee $SellFee -SellPrice $newSellPrice -buyprice $CurrentCryptPrice
